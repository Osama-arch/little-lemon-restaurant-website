  ...
  return (
    <>
      ...
      <header className='header '>
        <div className='header-container flex-sb center'>
          {windowWidth >= 999 ? (
            <>
              <div className='logo'>
                <a href='#'>
              ...
              <Navbar locate={'header'} page={page}></Navbar>
            </>
          ) : (
            <>
              <div
                ...
                {!showSidebar ? (
                  <HiBars3 size='3rem' className='transition svg-hover' />
                ) : (
                  <RiCloseLine
                    size='3rem'
                    className='transition svg-hover'></RiCloseLine>
                )}
              </div>
              <div
